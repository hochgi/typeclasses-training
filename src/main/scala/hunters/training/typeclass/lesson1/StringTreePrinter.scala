...
object StringTreePrinter {
   ...
   */
  def print(tree: StringTree): String = {
    ...
    def appendChildRec(prefix: String,
                       ...
                       sb: StringBuilder,
                       subtree: StringTree): StringBuilder = {

      var prefixSuffix = headPrefixSuffix
      subtree.value.linesIterator.foreach { valueLine =>
        sb.append(prefix)
          .append(prefixSuffix)
          .append(valueLine)
          .append('\n')
      ...
      subtree match {
        case StringTree(_, Nil) => sb
        case StringTree(_, nonEmptyChildren) =>
